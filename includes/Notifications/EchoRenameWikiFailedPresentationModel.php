...
class EchoRenameWikiFailedPresentationModel extends EchoEventPresentationModel {
	...
	public function getHeaderMessage(): Message {
		return $this->msg(
			'renamewiki-notification-header-renamewiki-failed',
	...
	public function getBodyMessage(): Message {
		...
		return $this->msg( 'renamewiki-notification-body-renamewiki-failed',
			$reason
		);
	}
